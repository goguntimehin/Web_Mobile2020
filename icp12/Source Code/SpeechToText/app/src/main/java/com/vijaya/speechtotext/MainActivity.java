...
public class MainActivity extends AppCompatActivity {
    ...
    private void recognition(String text){ // Recognize speaking
        ...
        else if(text.contains("what medicine should I take")){ // user will ask this
            speak(preferences.getString(NAME, null) + ", I think you have Fever. Please take this medicines");// speaker answer
        }
        else if(text.contains("I'm not feeling good what should I do")){// user will ask this
            speak("I can understand. I'm sorry about it");// speaker answer
        }

        else if(text.contains("thank you")){// user will ask this
            speak("Thank you too Take care, bye bye" + preferences.getString(NAME, null) );//speaker answer
        }
